...
function SLESS_add_script() {
	...
	<!--[if lte IE 8]>         <script src="<?php echo SAUCAL_TPL_LIB_URL( __FILE__ ); ?>/js/less-1.3.3.min.js"></script> <![endif]-->
	<!--[if gt IE 8]><!--> <script src="<?php echo SAUCAL_TPL_LIB_URL( __FILE__ ); ?>/js/less-2.3.1.min.js"></script> <!--<![endif]-->
	<?php
}
