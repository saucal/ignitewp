...
add_action( "init", function(){
    ...
    wp_register_script( SAUCAL_TPL_ID."-more-perfect-scrollbar", SAUCAL_TPL_LIB_URL(__FILE__)."/js/more-perfect-scrollbar.js", array(SAUCAL_TPL_ID."-perfect-scrollbar", "saucal-jquery-extension"), "0.1", false );
});
